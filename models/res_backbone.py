...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, strides=None, input_nc=3):
        ...
        self.conv1 = nn.Conv2d(input_nc, self.inplanes, kernel_size=7, stride=self.strides[0], padding=3,
                               bias=False)
    ...
    def _make_layer(self, block, planes, blocknum, stride=1, dilate=False):
