...
from loss.losses import get_alpha, softmax_helper, FocalLoss, mIoULoss, mmIoULoss

from misc.logger_tool import Logger, Timer

from misc.utils import de_norm, get_scheduler
...
class CDTrainer():
    ...
    def __init__(self, args, dataloaders):
        ...
        self.compare_metric = args.compare_metric
    ...
    def _collect_running_batch_states(self):
        ...
        self.train_result_dir = os.path.join(self.vis_dir, 'train')
        os.makedirs(self.train_result_dir, exist_ok=True)
        ...
        if np.mod(self.batch_id, 500) == 1:
            ...
            file_name = os.path.join(
                self.train_result_dir, 'istrain_'+str(self.is_training)+'_'+
    ...
    def _collect_epoch_states(self):
        ...
        self.epoch_acc = scores[self.compare_metric]
    ...
    def _forward_pass(self, batch):
        ...
        if self.is_TMSF == True:
            name = batch['name']
            self.G_pred = self.net_G(img1=img_in1, img2=img_in2, name=name)
